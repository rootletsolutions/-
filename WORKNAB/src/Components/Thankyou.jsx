    ...
    return (
        <div>
            ...
            <div className='thankyou'>
                <img src='../../public/assest/thankyou.png' />
                <h2>
                    Thank you!<br/>
                    Your request has submitted<br/>
                    We will get back to you soon.
                </h2>
                <button className='thankyoubtn' onClick={()=>navigate("/home")}>Go Back</button>
            </div>
            ...
            <footer className="footer">
                ...
                <p className='final'>opyright and Company Information : WorkNab © 2024. All rights reserved.</p>
            </footer>
        </div>
    )
}
